...
class Config:
    ...
    # GPU适配兼容性配置
    # GPU_FLAG = 'DeepSeek'  # 设置为 'RTX2080Ti' 启用RTX2080Ti适配，RTX4090对应AutoDL
    GPU_FLAG = 'RTX2080Ti'
    ...
    def _apply_gpu_config(cls):
        ...
        if cls.GPU_FLAG == 'RTX2080Ti':
            ...
            cls.EVAL_BATCH_SIZE = 50  # RTX2080Ti 批量大小
            ...
            cls.EVAL_BATCH_SIZE = 16  # RTX4090 批量大小
        ...
        elif cls.GPU_FLAG == "DeepSeek":
            # DeepSeek API模式配置
            print("检测到DeepSeek模式，启用API调用配置...")
            cls.MODEL_NAME = "DeepSeek"
            cls.EVAL_BATCH_SIZE = 50  # DeepSeek API批量大小
