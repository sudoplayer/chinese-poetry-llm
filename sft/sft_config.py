...
class Config:
    ...
    # GPU适配兼容性配置
    GPU_FLAG = 'RTX2080Ti'  # 设置为 'RTX2080Ti' 启用本地适配，其他值则对应AutoDL
    ...
    def _apply_gpu_config(cls):
        ...
        if cls.GPU_FLAG == 'RTX2080Ti':
            ...
            # RTX2080Ti 专用训练参数
            cls.PER_DEVICE_TRAIN_BATCH_SIZE = 8
            cls.GRADIENT_ACCUMULATION_STEPS = 8
            ...
            # RTX4090 专用训练参数
            cls.PER_DEVICE_TRAIN_BATCH_SIZE = 64
        ...
        cls.TRAINING_STEPS = int(cls.TRAINING_EPOCHS * (cls.IDX_END - cls.IDX_START) / cls.PER_DEVICE_TRAIN_BATCH_SIZE / cls.GRADIENT_ACCUMULATION_STEPS)
